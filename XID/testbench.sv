...
//  \   \         Application : ISE
//  /   /         Filename : ids_tb.tfw
// /___/   /\     Timestamp : Fri Mar 03 17:51:27 2023
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: 
    ...
    initial begin
      ...
      $dumpfile("dump.vcd");
        ...
        #20000;
      	...
      	//UDP Packet:      
      	in_wr = 1'b1;
      	in_data = 64'h004000080007003c;
      	in_ctrl = 8'hff;
      	//
      	#200;
      	//
      	in_data = 64'ha0369f092912004e;
      	in_ctrl = 8'h00;
      	//
      	#200;
      	//
      	in_data = 64'h4632430308004500;
      	//
      	#200;
      	//
      	in_data = 64'h0027c19b40004011;
      	//
      	#200;
      	//
      	in_data = 64'h65240a0100030a01;
      	//
      	#200;
      	//
      	in_data = 64'h0003eba51f990013;
      	//
      	#200;
      	//
      	in_data = 64'h812d686868686868;
      	//
      	#200;
      	//
      	in_data = 64'h6868686868686868;
        #200;
      	//
      	in_data = 64'h6868686868686868;
      	//
